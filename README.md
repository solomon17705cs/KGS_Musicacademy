...
Welcome to the **KGS Music Academy** management system. This application is designed to help you manage student enrollment, track musical progress, and send notifications easily.

---

## 🚀 One-Click Launch (Start Here)

We have made it easy to start the portal without using any complicated commands.
