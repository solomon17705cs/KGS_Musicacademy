                      ...
                      <View style={styles.feeStatusRow}>
                        <View style={[
                          ...
                          <Text style={[
                            ...
                            {
                              color: student.currentFeeStatus === 'paid' ? '#16a34a' : student.currentFeeStatus === 'pending' ? '#f97316' : '#94a3b8',
                            }
                          ]}>
                            Fee: {student.currentFeeStatus === 'not_attended' ? 'Not Attended' : student.currentFeeStatus}
                          </Text>
                        </View>
                      </View>
