...
const TOPIC_CHIPS_BY_INSTRUMENT: Record<string, string[]> = {
  guitar: ['Song (Exercises)', 'Chord changes', 'Strumming pattern', 'Scales', 'Fingerpicking', 'Theory topics'],
  keyboard: ['Song (Exercises)', 'Scales', 'Hand coordination', 'Sight reading', 'Chords', 'Theory topics'],
  piano: ['Song (Exercises)', 'Scales', 'Hand coordination', 'Sight reading', 'Chords', 'Theory topics'],
  violin: ['Song (Exercises)', 'Bowing technique', 'Scales', 'Intonation', 'Posture', 'Theory topics'],
  ...
  viola: ['Song (Exercises)', 'Bowing technique', 'Scales', 'Intonation', 'Theory topics'],
  theory: ['Song (Exercises)', 'Note reading', 'Rhythm notation', 'Scale theory', 'Ear training', 'Theory topics'],
};
